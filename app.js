...
todoForm.addEventListener('submit', function(e){
    // to prevent from page reloading automatically after pressing enter 
    e.preventDefault();
    addTodo();
})
...
// to store the todo is completed or not in local storage is done by storing the todo as a object 